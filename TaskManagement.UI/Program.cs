...
public static class Program
{
    public static async Task Main(string[] args)
    {
        ...
        Console.WriteLine("Позволяет пользователям добавлять, удалять, редактировать и выполнять задачи.");
        Console.WriteLine("Для управления задачами введите необходимое число с клавиатуры.");
        ...
        while (keyMenu != 10)
        {
            ...
            Console.WriteLine("нажмите 1, чтобы Вывести список всех задач");
            Console.WriteLine("нажмите 2, чтобы чтобы Добавить задачу");
            Console.WriteLine("нажмите 3, чтобы Редактировать задачу");
            Console.WriteLine("нажмите 4, чтобы Удалить задачу");
            Console.WriteLine("нажмите 5, чтобы Взять задачу в работу");
            Console.WriteLine("нажмите 6, чтобы Выполнить задачу");
            Console.WriteLine("нажмите 10, чтобы Выход из приложения");
